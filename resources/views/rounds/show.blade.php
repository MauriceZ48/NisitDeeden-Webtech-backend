        ...
        <div class="container mx-auto max-w-3xl">
            ...
            <div class="text-center mb-12">
                <span class="inline-block px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-bold uppercase tracking-widest rounded-full mb-4">
                    Official Award Recipients
                </span>
                <h1 class="text-3xl font-extrabold text-slate-900">
                    Academic Year {{ $applicationRound->academic_year }}
                </h1>
                <p class="text-slate-500 mt-2 font-medium">Semester {{ $applicationRound->semester }}</p>
                            ...
                            <ul class="divide-y divide-slate-100">
                                ...
                                @empty
                                    <li class="py-10 text-center">
                                        ...
                                        <p class="text-slate-400 font-medium text-sm">No recipients selected for this category yet.</p>
                                    </li>
                                @endforelse
                            </ul>
                        </div>
...
{{--                    NisitDeeden Excellence Management System--}}
{{--                </p>--}}
{{--            </div>--}}
        </div>
    </section>
